...
_whi     EQU     [edi+56]
result_a EQU     [edi+64]
d0      EQU     qword ptr [edi+80]
d1      EQU     qword ptr [edi+88]
w0      EQU     qword ptr [edi+96]
w1      EQU     qword ptr [edi+104]
fstart  EQU     dword ptr [edi+112]
fmstart EQU     dword ptr [edi+116]
pow     EQU     tbyte ptr [edi+128]
pow2     EQU    dword ptr [edi+128]
lut1    EQU     dword ptr [edi+144]
lut2    EQU     dword ptr [edi+192]
...
push edi
mov edi,[esp+8]
fld qword ptr _result+24            ;1u r3
fmul qword ptr f128                 ;2u R3
fld qword ptr _result+16            ;3u r2 R3
fmul qword ptr f96                  ;4u R2 R3
fld qword ptr _result+8             ;5u r1 R2 R3
fmul qword ptr f64                  ;6u R1 R2 R3
fxch st(1)                      ;6v R2 R1 R3
fld qword ptr _result               ;7u r0 R2 R1 R3
fmul qword ptr f32                  ;8u R0 R2 R1 R3
fxch st(3)                      ;8v R3 R2 R1 R0
fstp qword ptr _result+24           ;9-10 R2 R1 R0
fstp qword ptr _result+16           ;11-12 R1 R0
fstp qword ptr _result+8            ;13-14 R0
fstp qword ptr _result              ;15-16
pop edi
ret 4
...
push ebp
mov edi,[esp+16]
mov dword ptr _dhi,0
mov dword ptr _whi,0
mov eax,_d+4
mov ebx,_w+4
mov _dhi+4,eax
mov _whi+4,ebx
...
fild qword ptr _w           ;1u     w
fild qword ptr _d           ;2u     d w
fild qword ptr _power       ;3u     power d w
fild qword ptr _dhi         ;4u     d1 power d w
fild qword ptr _whi         ;5u     w1 d1 power d w
fxch st(2)              ;6u     power d1 w1 d w         (fild does not pair)
fstp tbyte ptr [pow]          ;7-9u   d1 w1 d w
fst  d1            ;10-11u d1 w1 d w
fsubr st(0),st(2)       ;12u    d0 w1 d w
fxch st(1)              ;12v    w1 d0 d w
fst  w1            ;13-14u w1 d0 d w
fsubr st(0),st(3)       ;15u    w0 d0 d w
fxch st(1)              ;15v    d0 w0 d w
fstp  d0           ;16-17u w0 d w
                        ;18     STALL                   (fstp)
fstp qword ptr w0           ;19-20u d w
fld f0                  ;21u    1 d w
fxch st(2)              ;21v    w d 1
fdiv st(2),st(0)        ;22[-60] w d 1/w
;qword pow=abcdefgh ijklmnop qrstuvwx yzABCDEF GHIJKLMN OPQRST00 000...
;word pow+8=3FFE+002E
mov eax,dword ptr pow       ;23u    eax=GHIJKLMN ...
mov edx,dword ptr pow+4     ;23v    edx=abcdefgh ...
shr eax,2               ;24u    eax=00GHIJKL ...
mov esi,edx             ;24v    esi=abcdefgh ...
shl esi,30              ;25u    esi=EF000000 ...
mov ecx,pow2+8     ;25v    ecx=3FFE+002E
or eax,esi              ;26u    eax=EFGHIJKL ...
sub ecx,03FFEh      ;26v    ecx=002E
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
not_overheat:
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
mov ebx,03F800000h      ;27u    ebx=(float) s=0,e=127,f=0; =1.0
...
inc ebx                 ;40v
and esi,0F8000000h      ;41u    esi=mnopq000...
and ebp,04000000h      ;41v    ebp=00000r00...
shl edx,6               ;42u    edx=stuvwx yzABCD EF0000 000000 00...
or esi,04000000h       ;42v    esi=mnopq100...
...
inc ebx                 ;45v
and esi,0F8000000h      ;46u    esi=stuvw000...
and ebp,04000000h      ;46v    ebp=00000x00...
shl edx,6               ;47u    edx=yzABCD EF0000 000000 00...
or esi,04000000h       ;47v    esi=stuvw100...
...
inc ebx                 ;50v
and esi,0F8000000h      ;51u    esi=yzABC000...
and ebp,04000000h      ;51v    ebp=00000D00...
shl edx,6               ;52u    edx=EF0000 000000 00...
or esi,04000000h       ;52v    esi=yzABC100...
...
fld dword ptr fstart        ;59     st w d 1/w
...
l7:
and esi,0F8000000h      ;1u     esi=EFGHI000...
and ebp,04000000h      ;1v     ebp=00000J00...
shl edx,6               ;2u     edx=KLMNOP QRST00...
or esi,04000000h       ;2v     esi=EFGHI1...
shr ebp,26              ;3u     ebp=J
...
and esi,0F8000000h      ;91u    esi=U...Y[Z]000...
...
fstp tbyte ptr result_a     ;173-5  y1/s X00/s X11/s 2X10/s y0/s 1/d 1/w
...
fld tbyte ptr result_a      ;189-191 a d1 Z-Z00/s Z00/s 1/d 1/w
fmul dword ptr amul         ;192u   a*amul d1 Z-Z00/s Z00/s 1/d 1/w
...
fmul dword ptr xmul         ;200u   x*xmul b+ 1/w d1 a*amul w1 1/d 1/w
...
fld qword ptr _result       ;218u   r0 A/d A x*xmul-y*w1 d1 y*w0 1/d 1/w
...
fstp qword ptr _result      ;246-7  A1 A-A0*d X-X0*w d1 X/w-X0 1/d 1/w
...
fld qword ptr _result+8     ;250u   r1 X1+ A-A0*d X-X0*w A11 A1 1/d 1/w
...
fstp qword ptr _result+8    ;270-1  A2 A-(A0+A1)*d X-(X0+X1)*w d1 X/w-X0-X1 1/d 1/w
...
fld qword ptr _result+16    ;274u   r2 X2+ A-(A0+A1)*d X-(X0+X1)*w A21 A2 1/d 1/w
...
fld qword ptr _result+24    ;285u   r3 X20 X-(X0+X1)*w-X21 A-(A0+A1+A2)*d R2 1/d 1/w
...
fstp qword ptr _result+16   ;291-2  r3+A3 X3
...
mov ebx,_w              ;296u
mov eax,_winc           ;296v
fstp qword ptr _result+24   ;297-8
add ebx,eax             ;299u
mov edx,_w+4            ;299v
adc edx,0               ;300u
mov _d+4,ecx            ;300v
...
fld qword ptr _result+24    ;1u     r3
fadd fm33               ;2u     r3hi+
fld qword ptr _result+24    ;3u     r3 r3hi+
fld qword ptr _result+16    ;4u     r2 r3 r3hi+
...
fstp qword ptr _result+24   ;12-13  r2hi+ r2+r3hi
fsub fm1                ;14u    r2hi r2+r3hi
fld qword ptr _result+8     ;15u    r1 r2hi r2+r3hi
...
fstp qword ptr _result+16   ;21-22  r1hi+ r1+r2hi
fsub f31                ;23u    r1hi r1+r2hi
fld qword ptr _result       ;24u    r0 r1hi r1+r2hi
...
fstp qword ptr _result+8    ;30-31  r0hi+ r0+r1hi
fsub f63                ;32u    r0hi r0+r1hi
fsubp st(1),st(0)       ;35u    R0
fstp qword ptr _result      ;38-39
...
;};
;
        fild qword ptr [edi-96]     ;       w
        fmul f2                 ;       4*w
        fild qword ptr [edi-80]     ;       c 4*w
        fild qword ptr [edi-72]     ;       e c 4*w
        fsub st(0),st(1)        ;       e-c c 4*w
        fstp dword ptr [edi-32]     ;       c 4*w
        mov eax,f4
        mov ebx,[edi-32]
        ...
        add eax,ecx
        mov [edi-32],eax
        fld dword ptr [edi-32]      ;       numterms tirstterm 4*w
        ...
        fistp qword ptr [edi-16]    ;       [edi-16]=numterms
        fistp qword ptr [edi-24]    ;       [edi-24]=firstterm
        fistp qword ptr [edi-32]    ;       [edi-32]=4*where-20*firstterm
        fild qword ptr [edi-16]     ;       numterms
        fild qword ptr [edi-80]
        faddp st(1),st(0)
        fistp qword ptr [edi-80]
;0            long d[2];
;8            long dinc;
;12           float amul;
;16           long w[2];
...
;44           long termcount;
        ...
        fild qword ptr [edi-32]     ;       where*4-firstterm*20
        fsub f2                 ;       where*4-firstterm*20-4
        fistp qword ptr [edi+32]    ;       power=where*4-firstterm*20-4
        mov dword ptr [edi+40],20   ;       powerinc=20
        fild qword ptr [edi-24]     ;       firstterm
        fmul fc20               ;       firstterm*20
        fadd f0                 ;       firstterm*20+1
        fistp qword ptr [edi]       ;       d=firstterm*20+1
        mov dword ptr [edi+8],20    ;       dinc=20
        fld f2                  ;       4
        fstp dword ptr [edi+12]     ;       amul=4
        fild qword ptr [edi-24]     ;       firstterm
        fmul fc20               ;       firstterm*20
        fadd fc3                ;       firstterm*20+3
        fistp qword ptr [edi+16]    ;       w=firstterm*20+3
        mov dword ptr [edi+24],20   ;       winc=20
        fld fcm1                ;       -1
        fstp dword ptr [edi+28]     ;       xmul=-1
        fild qword ptr [edi-16]     ;       numterms
        fistp qword ptr [edi+44]    ;       numterms=numterms
        push edi
        call POWERFUNC_P5

        fild qword ptr [edi-32]     ;       where*4-firstterm*20
        fsub f3                 ;       where*4-firstterm*20-8
        fistp qword ptr [edi+32]    ;       power=where*4-firstterm*20-8
        mov dword ptr [edi+40],20   ;       powerinc=20
        fild qword ptr [edi-24]     ;       firstterm
        fmul f3                 ;       firstterm*8
        fadd f0                 ;       firstterm*8+1
        fistp qword ptr [edi]       ;       d=firstterm*8+1
        mov dword ptr [edi+8],8     ;       dinc=8
        fld fcm8                ;       -8
        fstp dword ptr [edi+12]     ;       amul=-8
        fild qword ptr [edi-24]     ;       firstterm
        fmul fc20               ;       firstterm*20
        fadd fc5                ;       firstterm*20+5
        fistp qword ptr [edi+16]    ;       w=firstterm*20+5
        mov dword ptr [edi+24],20   ;       winc=20
        fld fcm1                ;       -1
        fstp dword ptr [edi+28]     ;       xmul=-1
        fild qword ptr [edi-16]     ;       numterms
        ...
        fistp qword ptr [edi+32]    ;       power=where*4-firstterm*20-10
        mov dword ptr [edi+40],20   ;       powerinc=20
        fild qword ptr [edi-24]     ;       firstterm
        fmul fc20               ;       firstterm*20
        fadd fc7                ;       firstterm*20+7
        fistp qword ptr [edi]       ;       d=firstterm*20+7
        mov dword ptr [edi+8],20    ;       dinc=20
        fld fcm4                ;       -4
        fstp dword ptr [edi+12]     ;       amul=-4
        fild qword ptr [edi-24]     ;       firstterm
        ...
        fistp qword ptr [edi+16]    ;       w=firstterm*8+3
        mov dword ptr [edi+24],8    ;       winc=8
        fld fcm1                ;       -1
        fstp dword ptr [edi+28]     ;       xmul=-1
        fild qword ptr [edi-16]     ;       numterms
        fistp qword ptr [edi+44]    ;       numterms=numterms
        ...
        fistp qword ptr [edi+32]    ;       power=where*4-firstterm*20-12
        mov dword ptr [edi+40],20   ;       powerinc=20
        fild qword ptr [edi-24]     ;       firstterm
        fmul fc20               ;       firstterm*20
        fadd fc9                ;       firstterm*20+9
        fistp qword ptr [edi]       ;       d=firstterm*20+9
        mov dword ptr [edi+8],20    ;       dinc=20
        fld f2                  ;       4
        fstp dword ptr [edi+12]     ;       amul=4
        fild qword ptr [edi-24]     ;       firstterm
        ...
        fistp qword ptr [edi+16]    ;       w=firstterm*20+11
        mov dword ptr [edi+24],20   ;       winc=20
        fld fcm1                ;       -1
        fstp dword ptr [edi+28]     ;       xmul=-1
        fild qword ptr [edi-16]     ;       numterms
        ...
        fistp qword ptr [edi+32]    ;       power=where*4-firstterm*20-15
        mov dword ptr [edi+40],20   ;       powerinc=20
        fild qword ptr [edi-24]     ;       firstterm
        fmul fc20               ;       firstterm*20
        fadd fc13               ;       firstterm*20+13
        fistp qword ptr [edi]       ;       d=firstterm*20+13
        mov dword ptr [edi+8],20    ;       dinc=20
        fld f1                  ;       2
        fstp dword ptr [edi+12]     ;       amul=2
        fild qword ptr [edi-24]     ;       firstterm
        fmul f3                 ;       firstterm*8
        fadd fc5                ;       firstterm*8+5
        fistp qword ptr [edi+16]    ;       w=firstterm*8+5
        mov dword ptr [edi+24],8    ;       winc=8
        fld f0                  ;       1
        fstp dword ptr [edi+28]     ;       xmul=1
        fild qword ptr [edi-16]     ;       numterms
        ...
        fistp qword ptr [edi+32]    ;       power=where*4-firstterm*20-18
        mov dword ptr [edi+40],20   ;       powerinc=20
        fild qword ptr [edi-24]     ;       firstterm
        fmul fc20               ;       firstterm*20
        fadd fc17               ;       firstterm*20+17
        fistp qword ptr [edi]       ;       d=firstterm*20+17
        mov dword ptr [edi+8],20    ;       dinc=20
        fld f0                  ;       1
        fstp dword ptr [edi+12]     ;       amul=1
        fild qword ptr [edi-24]     ;       firstterm
        fmul fc20               ;       firstterm*20
        fadd fc15               ;       firstterm*20+15
        fistp qword ptr [edi+16]    ;       w=firstterm*20+15
        mov dword ptr [edi+24],20   ;       winc=20
        fld f0                  ;       1
        fstp dword ptr [edi+28]     ;       xmul=1
        fild qword ptr [edi-16]     ;       numterms
        ...
        fistp qword ptr [edi+32]    ;       power=where*4-firstterm*20-20
        mov dword ptr [edi+40],20   ;       powerinc=20
        fild qword ptr [edi-24]     ;       firstterm
        fmul f3                 ;       firstterm*8
        fadd fc7                ;       firstterm*8+7
        fistp qword ptr [edi]       ;       d=firstterm*8+7
        mov dword ptr [edi+8],8     ;       dinc=8
        fld f0                  ;       1
        fstp dword ptr [edi+12]     ;       amul=1
        fild qword ptr [edi-24]     ;       firstterm
        ...
        fistp qword ptr [edi+16]    ;       w=firstterm*20+19
        mov dword ptr [edi+24],20   ;       winc=20
        fld fcm1                ;       -1
        fstp dword ptr [edi+28]     ;       xmul=-1
        fild qword ptr [edi-16]     ;       numterms
